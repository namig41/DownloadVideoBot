...
# Переопределяем URL базы данных из переменных окружения или settings
# Alembic использует синхронные драйверы, поэтому для PostgreSQL используем postgresql://
